...
const SLACK_WEBHOOK_URL = 'ALERTS_IMPORTANT_SLACK_WEBHOOK_URL' as const
...
const DERIVATIVE_DEVIANCE_THRESHOLD = 250 as const
const WBTC_BTC_DEVIANCE_THRESHOLD = 250 as const
